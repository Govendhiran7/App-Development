...
export default function FeedBack() {
  return (
      <div className="main">
      <h2>Reviews of Our Customers:<br/></h2>
      ...
      <div className="testimonial">
        ...
        <div className="testimonial-author">-Mr. Mandy Rose</div>
      </div>
      <div className="testimonial">
        <div className="testimonial-photo">
          <div className="photo-background"></div>
        ...
        <div className="testimonial-author">-Mr. George Robin</div>
      </div>
      <div className="testimonial">
        <div className="testimonial-photo">
          <div className="photo-background"></div>
        ...
        <div className="testimonial-author">-Mr. Kishore Aravind</div>
      </div>
    </div>
