...
export default function SignUp() {
    ...
    const handleSubmit=async(event)=>
    {
      ...
      if(username.length===0 ||  mobileno.length!==10  || emailid.length===0 ||  password.length===0 )
      {
        seterror(true);
  ...
  return (
    ...
    NAME <br/> <input type="text" value={username} placeholder="" onChange={e=>setName(e.target.value)}/><br/>
    <div>
    {error && username.length===0?
      <label style={{color:'red'}}>Name is required</label>:""} 
    </div><br/>
    MOBILE NUMBER<br/><input type="number" value={mobileno} placeholder="" onChange={e=>setMobileNum(e.target.value)}/><br/>
    <div>
